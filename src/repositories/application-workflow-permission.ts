...
import { IApplicationWorkflowPermissionInstance, IApplicationWorkflowPermissionAttributes } from '../models/application-workflow-permission';
...
export const saveApplicationWorkflowPermission =
    async (applicationWorkflowPermission: Omit<IApplicationWorkflowPermissionAttributes, 'id'>) => {
