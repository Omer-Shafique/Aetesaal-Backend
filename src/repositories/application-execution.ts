...
// import { IApplicationExecutionFormModel } from '../models/application-execution-form';
// import { IApplicationFormFieldModel } from '../models/application-form-field';
// import { IApplicationExecutionWorkflowModel } from '../models/application-execution-workflow';
...
//     }
//     return Models.ApplicationExecution.findAll<IApplicationExecutionInstance>({
...
//                 {
//                     model: Models.ApplicationExecutionForm,
//                     include: [{ model: Models.ApplicationFormField }],
//                     where: { isActive: true }
//                 },
//                 {
//                     model: Models.ApplicationExecutionWorkflow,
...
//                         {
//                             model: Models.ApplicationWorkflow,
//                             include: [{ model: Models.ApplicationWorkflowPermission }]
//                         }
//                     ]
//                 }
//             ]
...
//         return execution;
//     } catch (error) {
//         throw new Error(`Error fetching application execution by ID: ${error.message}`);
//     }
// };
...
// export const getDraftApplicationExecutionQuery = async (
//     userId: string,
//     status: string,
...
//     const result = await Database.query(query).then((res) => res[0] as IGetExecutionSelect[]);
//     return result;
// };

// export const getApplicationExecutionInProcessQuery = async (
//     payload: IApplicationExecutionInProcessQuery
// ): Promise<IGetExecutionSelect[]> => {
//     let query = `select distinct execution.id, execution."createdAt", execution."createdBy", app."name",
//         u."managerId", u."departmentId", u."officeLocationId", execution."applicationId", execution."updatedAt",
...
// export const getApplicationExecutionByWorkflowTypeAndStatusQuery = async (
//     status: string,
//     type: string,
//     applicationId?: string,
//     startDate?: string,
...
// export const getParticipatedApplicationExecutionQuery = async (
//     userId: string,
//     searchText?: string,
//     startDate?: string,
//     endDate?: string
...
//     `).then((res) => res[0] as IGetExecutionSelect[]);
//     return result;
// };

// export const getTotalApplicationExecutionQuery = async (
//     applicationId: string,
//     startDate: string,
//     endDate: string
// ): Promise<IGetExecutionSelect[]> => {
...
//         inner join "user" u on u.id = execution."createdBy"
//         inner join "applicationExecutionWorkflow" ew on ew."applicationExecutionId" = execution.id
//         and ew.status IN (${status.map(s => `'${s}'`).join(',')}) and ew."isActive" = true
//         inner join "applicationWorkflow" workflow on ew."applicationWorkflowId" = workflow.id
...
// export const getParticipatedUsersByExecutionId = async (executionId: string): Promise<IGetParticipatedUserSelect[]> => {
//     const result = await Database.query(`
...
//     `).then((res) => res[0] as IGetParticipatedUserSelect[]);
//     return result;
// };
...
// //     return Models.ApplicationExecution.findAll({ where: { id: { [Op.in]: ids } } });
// // };
...
export const getApplicationExecutionsByIds = async () => {
    return Models.ApplicationExecution.findAll({
        attributes: ['id', 'applicationId', 'title', 'startedAt', 'status', 'createdAt', 'updatedAt', 'createdBy'],
        where: {
            isActive: true,
...
export const deleteApplicationExecution = async (_id: string, updatedBy: string) => {
    return Models.ApplicationExecution.update({ isActive: false, updatedBy }, { where: { /* No filtering by id */ } });
};
